...
import com.tadreik.emoji.R;
import com.tadreik.emoji.showcase.*;
import com.tadreik.emoji.showcase.AnimationFactory;
import com.tadreik.emoji.showcase.AnimatorAnimationFactory;
import com.tadreik.emoji.showcase.ApiUtils;
import com.tadreik.emoji.showcase.MaterialShowcaseDrawer;
import com.tadreik.emoji.showcase.NewShowcaseDrawer;
import com.tadreik.emoji.showcase.NoAnimationFactory;
import com.tadreik.emoji.showcase.OnShowcaseEventListener;
import com.tadreik.emoji.showcase.ShotStateStore;
import com.tadreik.emoji.showcase.ShowcaseAreaCalculator;
import com.tadreik.emoji.showcase.ShowcaseDrawer;
import com.tadreik.emoji.showcase.targets.Target;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

import static com.tadreik.emoji.showcase.AnimationFactory.AnimationEndListener;
import static com.tadreik.emoji.showcase.AnimationFactory.AnimationStartListener;
...
public class ShowcaseView extends RelativeLayout
    ...
    private com.tadreik.emoji.showcase.ShowcaseDrawer showcaseDrawer;
    private final com.tadreik.emoji.showcase.ShowcaseAreaCalculator showcaseAreaCalculator;
    private final com.tadreik.emoji.showcase.AnimationFactory animationFactory;
    private final com.tadreik.emoji.showcase.ShotStateStore shotStateStore;
    ...
    private com.tadreik.emoji.showcase.OnShowcaseEventListener mEventListener = com.tadreik.emoji.showcase.OnShowcaseEventListener.NONE;
    ...
    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, boolean newStyle) {
        ...
        com.tadreik.emoji.showcase.ApiUtils apiUtils = new com.tadreik.emoji.showcase.ApiUtils();
        if (apiUtils.isCompatWithHoneycomb()) {
            animationFactory = new com.tadreik.emoji.showcase.AnimatorAnimationFactory();
        } else {
            animationFactory = new com.tadreik.emoji.showcase.NoAnimationFactory();
        }
        showcaseAreaCalculator = new com.tadreik.emoji.showcase.ShowcaseAreaCalculator();
        shotStateStore = new com.tadreik.emoji.showcase.ShotStateStore(context);
        ...
        if (newStyle) {
            showcaseDrawer = new com.tadreik.emoji.showcase.NewShowcaseDrawer(getResources(), context.getTheme());
        } else {
    ...
    public void setOnShowcaseEventListener(com.tadreik.emoji.showcase.OnShowcaseEventListener listener) {
        if (listener != null) {
            mEventListener = listener;
        } else {
            mEventListener = com.tadreik.emoji.showcase.OnShowcaseEventListener.NONE;
        }
    }
    ...
    public static class Builder {
         ...
         * {@link #setShowcaseDrawer(com.tadreik.emoji.showcase.ShowcaseDrawer)}
         */
        @Deprecated
        ...
        /**
         * Create the {@link com.tadreik.emoji.showcase.ShowcaseView} and show it.
         *
        ...
        public Builder withNewStyleShowcase() {
            return setShowcaseDrawer(new com.tadreik.emoji.showcase.NewShowcaseDrawer(activity.getResources(), activity.getTheme()));
        }
         ...
         */
        public Builder setShowcaseDrawer(com.tadreik.emoji.showcase.ShowcaseDrawer showcaseDrawer) {
    ...
    /**
     * @see com.tadreik.emoji.showcase.ShowcaseView.Builder#setSingleShot(long)
     */
    ...
    /**
     * @see com.tadreik.emoji.showcase.ShowcaseView.Builder#hideOnTouchOutside()
     */
    @Override
    ...
    /**
     * @see com.tadreik.emoji.showcase.ShowcaseView.Builder#doNotBlockTouches()
     */
    @Override
    ...
    /**
     * @see com.tadreik.emoji.showcase.ShowcaseView.Builder#setStyle(int)
     */
    @Override
